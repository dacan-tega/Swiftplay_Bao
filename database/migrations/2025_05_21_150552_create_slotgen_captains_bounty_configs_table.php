...
return new class extends Migration
{
    ...
    {
        Schema::create('slotgen_captains_bounty_configs', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('slotgen_captains_bounty_configs')->insert(
            [
                'win_ratio' => 50,
                'feature_ratio' => 50,
                'feature_winvalue' => 50,
    ...
    {
        Schema::dropIfExists('slotgen_captains_bounty_configs');
    }
};
