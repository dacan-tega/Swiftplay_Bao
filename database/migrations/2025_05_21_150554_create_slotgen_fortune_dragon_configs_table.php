...
return new class extends Migration
{
    ...
    {
        Schema::create('slotgen_fortune_dragon_configs', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('slotgen_fortune_dragon_configs')->insert(
            [
                'win_ratio' => 50,
                'feature_ratio' => 50,
                'feature_winvalue' => 50,
    ...
    {
        Schema::dropIfExists('slotgen_fortune_dragon_configs');
    }
};
