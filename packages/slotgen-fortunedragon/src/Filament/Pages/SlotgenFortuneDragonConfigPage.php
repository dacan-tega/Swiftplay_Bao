...
namespace Slotgen\SlotgenFortuneDragon\Filament\Pages;
...
use Slotgen\SlotgenFortuneDragon\Models\SlotgenGame;
...
class SlotgenFortuneDragonConfigPage extends Page
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'slotgen-fortunedragon::filament.pages.config-page';

    public ?array $data = [];

    public SlotgenFortuneDragonConfig $setting;

    public function mount(): void
    {
        $rtpConfig = SlotgenFortuneDragonConfig::first();
        if (! empty($rtpConfig)) {
    ...
    public function submit(): void
    {
        ...
        try {
            // dd($this->data);
            $setting = SlotgenFortuneDragonConfig::first();
            if (! empty($setting)) {
                ...
                // dd($this->data);
                if (SlotgenFortuneDragonConfig::create($this->data)) {
                    Notification::make()
                        ->title('Setting add')
    ...
    public function extractFile($fileName, $language = 'en')
    {
        ...
        if ($folder != null) {
            ...
            // $data = [
            //     'game_name'        => $name,
            //     'game_class'     => "Slotgen\\SlotgenFortuneDragon\\SlotgenFortuneDragon",
            // ];
            // $slotgen->fill($data);
            // $slotgen->save();
            $gamePrivateFolder = storage_path('app/private/fortune_dragon');
            $localtionStorage = 'app/private/fortune_dragon';
            ...
            //File::copy(__DIR__ . '/../../../resources/games/fortunedragon-logo.png', $gamePublicFolder . '/fortunedragon-logo.png');
        }
    }
}
